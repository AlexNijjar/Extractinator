...
public class DeepslateCabinGenerator {
    ...
    static {
        ...
        StructurePools.register(
                new StructurePool(
                        new TEIdentifier("deepslate_intact_cabin_top"),
                        new Identifier("empty"),
                        ImmutableList.of(
                                new Pair<>(StructurePoolElement.ofSingle(TheExtractinator.MOD_ID + ":cabin/deepslate/cabin_top_1"), 1)
                        ),
                        StructurePool.Projection.RIGID
                )
        );
        ...
        StructurePools.register(
                new StructurePool(
                        new TEIdentifier("deepslate_intact_cabin_bottom"),
                        new Identifier("empty"),
                        ImmutableList.of(
                                new Pair<>(StructurePoolElement.ofSingle(TheExtractinator.MOD_ID + ":cabin/deepslate/cabin_bottom_1"), 1)
                        ),
                        StructurePool.Projection.RIGID
                )
        );
        ...
        StructurePools.register(
                new StructurePool(
                        new TEIdentifier("deepslate_cabin_top"),
                        new Identifier("empty"),
                        ImmutableList.of(
                                new Pair<>(StructurePoolElement.ofSingle(TheExtractinator.MOD_ID + ":cabin/deepslate/cabin_top_2"), 1),
                                new Pair<>(StructurePoolElement.ofSingle(TheExtractinator.MOD_ID + ":cabin/deepslate/cabin_top_3"), 1),
                                new Pair<>(StructurePoolElement.ofSingle(TheExtractinator.MOD_ID + ":cabin/deepslate/cabin_top_4"), 1)
                        ),
                        StructurePool.Projection.RIGID
                )
        );
        ...
        StructurePools.register(
                new StructurePool(
                        new TEIdentifier("deepslate_cabin_bottom"),
                        new Identifier("empty"),
                        ImmutableList.of(
                                new Pair<>(StructurePoolElement.ofSingle(TheExtractinator.MOD_ID + ":cabin/deepslate/cabin_bottom_2"), 1),
                                new Pair<>(StructurePoolElement.ofSingle(TheExtractinator.MOD_ID + ":cabin/deepslate/cabin_bottom_3"), 1),
                                new Pair<>(StructurePoolElement.ofSingle(TheExtractinator.MOD_ID + ":cabin/deepslate/cabin_bottom_4"), 1)
                        ),
                        StructurePool.Projection.RIGID
                )
        );
