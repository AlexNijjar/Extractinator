...
public class ModRecipeTypes {
    ...
    public static final Supplier<RecipeType<ExtractinatorRecipe>> EXTRACTINATOR_RECIPE = RECIPE_TYPES.register("extractinating", () -> CodecRecipeType.of("extractinating"));
}
