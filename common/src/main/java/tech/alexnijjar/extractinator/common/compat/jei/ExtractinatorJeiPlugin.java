...
import dev.alexnijjar.extractinator.common.compat.jei.ExtractinatorCategory;
...
public class ExtractinatorJeiPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        assert level != null;
        registration.addRecipes(dev.alexnijjar.extractinator.common.compat.jei.ExtractinatorCategory.RECIPE, level.getRecipeManager().getAllRecipesFor(ModRecipeTypes.EXTRACTINATOR_RECIPE.get()));
    }

    @Override
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(ModItems.EXTRACTINATOR.get().getDefaultInstance(), dev.alexnijjar.extractinator.common.compat.jei.ExtractinatorCategory.RECIPE);
    }
}